...
extern void I2C_MasterSendData(uint8_t SlaveAddr,uint8_t *pTxbuffer, uint32_t Len);
extern void I2C_MasterReceiveData(uint8_t SlaveAddr,uint8_t *pRxbuffer, uint32_t Len);
...
void I2C_Read(uint8_t ADDR, uint8_t *i2cBif, uint8_t NofData)
{
	...
	I2C_MasterSendData( MPUADDR, i2cBuf, 1);

	I2C_MasterReceiveData(MPUADDR,i2cBif,NofData);
}
...
void I2C_Write8(uint8_t ADDR, uint8_t data)
{
	...
	I2C_MasterSendData(MPUADDR, i2cData, 2);
...
void MPU6050_Config(MPU_ConfigTypeDef *config)
{
	...
	_delay_ms(100); // should wait 10ms after changeing the clock setting.
